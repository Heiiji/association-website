<template>
    <div class="main">
        <div class="gCol">
            <div class="card">
                <img alt="icon" src="https://images.ecosia.org/YMuNVLA9Wj_emmiGk_keeqBB0ok=/0x390/smart/https%3A%2F%2Fi.ytimg.com%2Fvi%2FqvKrI0lv5ts%2Fmaxresdefault.jpg" style="float: right; border-radius: 400px; width: 100px"/>
                <h3>Différence entre un chat errant et un chat libre ?</h3>
<br/>
...
<br/><br/>
            ...
            <div class="card">
                <h3>Les chats « errants »</h3>
<br/>
<ul>
    <li>Provoquent des nuisances sonores (bagarres, miaulements) et olfactives marquages urinaires malodorants, bagarres nocturnes, bruits et miaulements intempestifs,destructions de poubelles.</li>
    <li>Représentent un risque sanitaire pour les autres animaux domestiques. Ces animaux souffrant parfois de malnutrition et de maladie. Compte tenu de leurs conditions d’animaux errants, ils ne bénéficient la plupart du temps d’aucun suivi sanitaire.</li>
    <li>Prolifèrent de façon exponentielle (un couple de chats peut donner théoriquement en 5 ans, 15 552 descendants).</li>
</ul>
                <h4 style="text-align: center; color: darkgreen">Mais</h4>
<ul>
    <li>Ils remplissent une fonction sanitaire en chassant et contenant les populations de rats, souris une fois stérilisés</li>
    <li>Ils ne se bagarrent plus et ne délimitent plus leur territoire par des urines malodorantes, plus de miaulements en pleine nuit, plus de poubelles visitées.</li>
    <li>Ils ne contaminent plus des maladies infectieuses comme le FIV, transmis par rapport sexuel et bagarres.</li>
    <li>La population des chats « errants » est stabilisée, car même stérilisés,ils continuent à protéger leur territoire et empêchant d’autres arrivants de s’installer.</li>
    <li>En petit nombre, ils sont bien acceptés des habitants. Craintifs ils fuient devant le bruit et devant un inconnu ;ils n’agressent jamais l’homme sauf quand celui-ci veut le saisir brutalement ; aucune des maladies propres au chat (FIV, leucose, coryza,typhus…) n’est transmissible à l’Homme ; le chat est l’un des rares animaux à enterrer ses déjections, sauf le mâle en rut.</li>
    <li>Les autres méthodes de régulation (campagne d’euthanasie généralisée, etc) sont à la fois plus archaïques mais surtout beaucoup plus coûteuses et inefficaces. Il s’agit de réguler efficacement la prolifération des félins tout en assurant la protection des chats dits « libres » qui participent à l’environnement urbain et ont « droit de cité ».</li>
    <li>La seule méthode efficace de contrôle des populations de chats sauvages.</li>
</ul>

            </div>
            <div class="card">
                <h3>Les causes de la prolifération</h3>
                <br/>
...
<br/><br/>
                ...
                <br/><br/>
                <ul>
                    <li>Créer votre propre association</li>
                    <li>Alerter la fondation Brigitte Bardot</li>
                </ul>
                <br/>
                <div style="background-color: gray; padding: 20px; color: black; border-radius: 6px;">
                <span style="color: red;">Attention</span><br/><br/>
...
<br/>
                ...
                <h4 style="text-align: center">Loi sur la stérilisation</h4>
<br/>
                ...
                Article L212-10
                <br/><br/>
                Modifié par LOI n°2016-1087 du 8 août 2016 – art. 154
                <br/><br/>
                ...
                <h4 style="text-align: center">Loi sur la gestion des colonies de chats dits libres</h4>
                <br/><br/><br/><br/>
                Fiche pratique : gestion des colonies de chats dits libres (mise en oeuvre de l’article L211-27 du Code rural)
                <br/><br/>
                Abréviations :<br/>
                CGCT : Code Général des Collectivités Territoriales<br/>
                CRPM : Code Rural et de la Pêche Maritime<br/>
                APA : Association de Protection Animale<br/>
                <br/><br/>

                • Bases juridiques (extraits en annexe)
                <br/>Code général des collectivités territoriales
                <br/><br/>
                ...
                <br/>Article L211-22 : les maires prennent toutes dispositions pour empêcher la divagation des chiens et des chats ;
                <br/>Article L211-23 : définition de la divagation des chiens et des chats
                <br/>Article L211-27 : cas des chats vivant en groupe dans les lieux publics de la commune sans propriétaire ou détenteur (animaux errants) ;
                <br/>Art. L. 211-27. – Le maire peut, par arrêté, à son initiative ou à la demande d’une association de protection des animaux, faire procéder
                <br/>à la capture de chats non identifiés, sans propriétaire ou sans  détenteur, vivant en groupe dans des lieux publics de la commune, afin de faire procéder à leur stérilisation et à leur identification conformément à l’article L. 214-5, préalablement à leur relâcher dans ces mêmes lieux. Cette identification doit être réalisée au nom de la commune ou de ladite association.

                <br/><br/>
                La gestion, le suivi sanitaire et les conditions de la garde au sens de l’article L. 211-11 de ces populations sont placés sous la responsabilité du représentant de la commune et de l’association de protection des animaux mentionnée à l’alinéa précédent.
                <br/>Article L241-15 : pour tous les actes de la compétence vétérinaire, le maire doit faire appel au vétérinaire ;
                <br/>Article R211-12 d) : le maire doit informer la population des lieux, jours et heures des campagnes de capture des animaux errants.
                <br/>Arrêté ministériel du 3 avril 2014 : dispositions spécifiques aux fourrières et mise en oeuvre de l’article L211-27

                <br/><br/>
                •Le maire et les animaux errants :
                <br/><br/>

                <br/>1- Le maire a la charge de la police municipale et rurale sous le contrôle du représentant de l’Etat. (L2212-1 et L2212-2 du CGCT).
                <br/>2- La divagation des animaux étant interdite (L211-19-1 du CRPM), de par ses pouvoirs de police municipale (L2212-2 du CGCT) le maire doit prendre toutes dispositions pour empêcher la divagation des chiens et des chats (L2212-2 7° du CGCT et L211-22 du CRPM), notamment par la conduite en fourrière.
                <br/>Définition de la divagation d’un chat
                <br/>1- Un chat est en divagation (L211-23 du CRPM) si :
                <br/>a. Il n’est pas identifié et trouvé à plus de deux cents mètres des habitations.
                <br/>b. Il est trouvé à plus de mille mètres du domicile de son maître et n’est pas sous la surveillance directe de celui-ci.
                <br/>c. Il n’a pas de propriétaire connu (absence d’identification) et qu’il est saisi sur la voie publique.
                <br/>d. Il n’a pas de propriétaire connu (absence d’identification) et qu’il est saisi sur la propriété d’autrui.
                <br/>Parmi les animaux en divagation, le législateur a distingué le cas des chats non identifiés vivant en groupe dans les lieux publics de la commune, sans propriétaire ou détenteur. Sur le territoire de la commune, le maire assume la garde juridique de ces animaux dont la provenance et le statut sanitaire sont inconnus. On peut noter le risque de transmission de zoonoses, par exemple la toxoplasmose transmissible à la femme enceinte non immunisée ou le risque de rage qui est faible mais ne doit pas être exclu
                ...
                <br/>– mise en fourrière : solution inadaptée pour des animaux ne pouvant être mis à l’adoption car mal socialisés à l’homme du fait de leur mode de vie donc à écarter dans la mesure du possible.
                <br/>– mise en oeuvre de l’article L211-27 du CRPM : solution à privilégier selon l’arrêté du 3 avril 2014. Ces animaux errants vont dès lors acquérir le statut de chat dit « libre », sous la garde et la responsabilité juridique de la mairie et de l’association de protection animale partenaire.
                <br/><br/>

                •Conditions de mise en oeuvre de l’article L211-27 du CRPM
                <br/>SEPT actions indissociables, dans l’ordre chronologique :
                <br/><br/>

                <br/>1- Prise d’un arrêté municipal et d’une convention quadripartite par le maire (seul décisionnaire) : voir exemples d’arrêté municipal et de convention en annexe.
                <br/>2 – La campagne de capture doit faire l’objet préalablement d’une information de la population au moins une semaine à l’avance (R211-12 du CRPM), permettant aux propriétaires de chats de garder les animaux à la maison et/ou de les faire identifier.
                <br/>3- Le maire fait procéder à la capture (par l’APA en général) des chats éligibles c’est à dire qu’ils répondent aux 3 conditions suivantes :
                <br/>– non identifiés (un chat identifié capturé doit être dirigé vers la fourrière aux fins de restitution à son propriétaire.)
                <br/>Et – sans propriétaire ou sans détenteur ;
                <br/>Et – qui vivent en groupe sur les lieux publics de la commune (ce qui exclut les animaux du domaine privé).
                <br/>4- Le maire fait procéder à leur stérilisation.
                <br/>Le vétérinaire pratique en même temps un contrôle sanitaire de l’animal selon la politique sanitaire définie avec l’association de protection animale.
                <br/>5- Le maire fait procéder à leur identification
                <br/>Il ne peut s’agir que du procédé agréé d’identification (L212-10 du CRPM) complété d’une marque visible sur l’animal (ex : encoche sur l’oreille) permettant le suivi de la colonie.
                <br/>6- Les animaux sont remis sur leur lieu de capture, ils ne doivent pas être placés en fourrière en vue d’une adoption.
                <br/>7- La gestion, le suivi sanitaire et les conditions de garde de ces populations qui ont acquis le statut de « chats libres » sont sous la responsabilité du représentant de la commune et de l’association.
                <br/><br/>

                •Les conditions de réussite d’après les expériences déjà conduites :
                <br/><br/>

                <br/>– agir rapidement et éviter que les colonies ne soient surpeuplées (risque accru de maladies)
                <br/>– agir méthodiquement : traiter entièrement une colonie avant de passer à une autre afin de la stabiliser (taux minimal de stérilisation : 80%)
                <br/>– faire gérer dans la durée la surveillance des colonies par des associations permet de détecter des nouveaux arrivants et d’effectuer un suivi sanitaire (contre les épidémies et les zoonoses) ainsi qu’une médiation dans le quartier.
                <br/>Les rôles des partenaires de la mairie sont les suivants :
                <br/>1- APA : localisation des colonies, évaluation des populations, capture et remise sur les lieux avec les services municipaux (contrôle), gestion après remise sur les lieux.
                <br/>2- Vétérinaires : réalisation des actes vétérinaires (stérilisation, identification, soins). La
                <br/>relation directe entre le maire et les praticiens est fixée par la loi (L241-15 du CRPM).
                <br/>Les APA ne peuvent pas être partie au contrat de soin (dont la stérilisation et l’identification) qui lie le maire dans le cadre de ses pouvoirs de police municipale en tant que gardien juridique de l’animal errant et les docteurs vétérinaires qui exécutent des actes de leur seule compétence.
                <br/>3- Fourrière : les fourrières peuvent participer à la campagne pour la capture et/ou l’hébergement provisoire des animaux capturés avant et après stérilisation/soins (modalités selon convention). D’autre part, les chats identifiés au nom d’un propriétaire et capturés lors des campagnes sont remis directement à leur détenteur par les
                fourrières.
            </div>
        </div>
    </div>
